...
public class Tables {
    ...
    public static int[] createTables(Connection conn) throws SQLException {
        try (Statement s = conn.createStatement()) {
            ...
            s.addBatch(
                    "CREATE TABLE IF NOT EXISTS MATRICULA(IDMATRICULA INT AUTO_INCREMENT PRIMARY KEY, ALUMNO INT REFERENCES ALUMNO(IDALUMNO), ASIGNATURA INT REFERENCES ASIGNATURA(CODASIGN), PROFESOR INT REFERENCES PROFESOR(CODPROF));");
